    ...
    .then(data =>{
        ...
        if(data.moreLoad === false){
            ...
            <div class="reacts_to_post">
                ...
                <div class="bowl_reacted">
                    <div class="icon_React icon_React_share" data-username="${data.username}" data-id_post="${data.id_post}">
...
function sharePost(){
    let icon_React_share = document.querySelectorAll(".icon_React_share");
    icon_React_share.forEach(post =>{
        post.addEventListener('click', ()=>{

            post.parentElement.parentElement.children[2].children[0].classList.add('react')
            setTimeout(()=>{
                post.parentElement.parentElement.children[2].children[0].classList.remove('react')
            },500)
